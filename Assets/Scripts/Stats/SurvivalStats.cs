...
public class SurvivalStats : MonoBehaviour
{
    ...
    public float maxSuitDurability;
    ...
    public void DamageHarvesting()
    {
        ...
        currentSuitDurability = Mathf.Max(0, currentHunger - havestingDamage);
        CheckDeath();
    }
    public void DamageCrafting()
    {
        ...
        currentSuitDurability = Mathf.Max(0, currentHunger - craftingDamage);
        CheckDeath();
    }
    ...
    public void EatFood(float amount)
    {
        ...
        {
            FloatingTextManager.instance.Show($"허기회복+{amount}", transform.position + Vector3.up);
        }
    }
